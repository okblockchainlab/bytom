...
import (
	"encoding/json"
	"github.com/bytom/okwallet/okwallet"
	"regexp"
)
...
func getAddressByPrivateKeyExecute(env *C.JNIEnv, args []string) C.jobjectArray {
	...
	return setSuccessResult(env, addr)
}
...
//export Java_com_okcoin_vault_jni_bytom_Bytomj_execute
func Java_com_okcoin_vault_jni_bytom_Bytomj_execute(env *C.JNIEnv, _ C.jclass, _ C.jstring, jcommand C.jstring) C.jobjectArray {
